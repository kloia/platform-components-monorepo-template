...
terraform {
  # TODO: consider picking a more up-to-date terraform version
...
echo "Module $MODULE_NAME created, you should create a new branch and commit these initial changes now
